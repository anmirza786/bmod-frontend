        ...
        <div className="flex wrap" style={{ marginTop: "80px" }}>
          ...
          >
            ...
            <div className="flex space-around">
              ...
              <h3 style={{ color: "white" }}>$ {state.idea.required_investment}</h3>
            </div>
            <div className="flex space-around">
              <h3 style={{ color: "white", fontWeight: "bold" }}>
                Share Percentage in Total Investment Required
              </h3>
              <h3 style={{ color: "white" }}>{state.idea.investment_percentage}%</h3>
            </div>
          ...
          >
            <div className="flex space-around mamber-since">
              ...
              <span style={{ color: "white" }}>${state.idea.required_investment}</span>
            </div>
            <div className="flex space-around mamber-since">
              <span style={{ color: "white", fontWeight: "bold" }}>
                Share Percentage/Total
              </span>
              <span style={{ color: "white" }}>{state.idea.investment_percentage}%</span>
            </div>
            <button
